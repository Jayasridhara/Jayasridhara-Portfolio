        ...
        {isMobileMenuOpen && (
          <nav className="md:hidden bg-gray-800 shadow-xl py-4 transition-all duration-300 ease-in-out">
            ...
            <div className="px-6 pt-4">
              <button
                onClick={handleOpenResume}
                className="cursor-pointer w-full flex items-center justify-center space-x-2 bg-teal-600 text-gray-900 px-4 py-3 rounded-lg font-semibold text-base shadow-xl hover:bg-teal-500 transition duration-300 "
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <FadeInOnScroll animation="fadeInRight" delay={400} className="bg-gray-900 p-6 rounded-lg shadow-xl border border-gray-700">
            ...
            <ul className="space-y-3 text-gray-300">
              {['React.js (Hooks, Router)', 'Node.js & Express.js', 'MongoDB & Mongoose', 'Redux Toolkit & Context', 'JavaScript (ES6+)', 'RESTful API Design', 'Tailwind CSS / CSS', 'Git & GitHub/GitLab',"PHP","MS SQL"].map((skill, index) => (
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-2xl shadow-2xl text-center max-w-sm w-full">
            <div className="flex flex-col items-center space-y-4">
              <div className="w-16 h-16 flex items-center justify-center rounded-full border-4 border-green-500 text-green-500 text-4xl">
                ✓
              </div>
